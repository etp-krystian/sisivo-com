...
<div class="contact-layout">
  <section class="contact-intro" aria-labelledby="contact-intro-title">
    ...
    <ol class="contact-steps">
      <li><strong>1.</strong> We review your current workflow and goal.</li>
      <li><strong>2.</strong> We suggest the best first implementation scope.</li>
      <li><strong>3.</strong> We align on timeline, systems, and success metrics.</li>
    </ol>
  </section>
...
<section class="content-page-cta" aria-label="Contact page call to action">
  ...
  <p>Book a discovery call and we will map your workflow live with you.</p>
  <div class="home-cta">
